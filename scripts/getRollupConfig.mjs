 ...
 * @param {("mjs" | "esm" | "cjs" | "umdDev" | "umdProd")[]} targets - The targets.
 * @returns {import('rollup').RollupOptions[]}
 */
export function buildConfigs(
  opts,
  targets = ['mjs', 'esm', 'cjs', 'umdDev', 'umdProd']
) {
  ...
  // @ts-expect-error
  return [
    targets.includes('mjs') && mjs(options),
    targets.includes('esm') && esm(options),
    targets.includes('cjs') && cjs(options),
    targets.includes('umdDev') && umdDev({ ...options, external: umdExternal }),
    targets.includes('umdProd') &&
